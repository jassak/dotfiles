...
-- BUG: Can't make ToggleColorscheme to work
--local colorschemes = { "tokyonight", "catppuccin-latte" }
--local current_index = 1

--function ToggleColorscheme()
--    current_index = 3 - current_index  -- Toggle between 1 and 2
--    local new_colorscheme = colorschemes[current_index]

--    vim.cmd("colorscheme " .. new_colorscheme)
--    if new_colorscheme == "tokyonight" then
...
--vim.keymap.set("n", "<leader>cc", ToggleColorscheme, { noremap = true, silent = true })
